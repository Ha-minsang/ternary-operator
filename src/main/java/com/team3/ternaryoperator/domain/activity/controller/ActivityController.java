...
public class ActivityController {
    ...
    public ResponseEntity<CommonResponse<PageResponse<ActivityResponse>>> getActivities(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(CommonResponse.success(response, "활동 로그 조회 성공."));
    }
    ...
    public ResponseEntity<CommonResponse<List<MyActivityResponse>>> getMyActivities(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(CommonResponse.success(response, "내 활동 로그 조회 성공."));
    }
}
